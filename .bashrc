...
export PS1=$IBlack$Time24h\ $Cyan$UserName\ $BYellow/$PathShort$Color_Off$Color_Off'$(git branch &>/dev/null;\
if [ $? -eq 0 ]; then \
...
alias grep='GREP_COLOR="7;33;40" LANG=C grep --color=auto'
